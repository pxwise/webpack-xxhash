...
JsonpMainTemplatePlugin.prototype.apply = function(mainTemplate) {
	...
	mainTemplate.plugin("hash", function(hash) {
		hash.update(new Buffer("jsonp"));
		hash.update(new Buffer("4"));
		hash.update(new Buffer(this.outputOptions.filename + ""));
		hash.update(new Buffer(this.outputOptions.chunkFilename + ""));
		hash.update(new Buffer(this.outputOptions.jsonpFunction + ""));
		hash.update(new Buffer(this.outputOptions.hotUpdateFunction + ""));
	});
};
